import Common from '@share/errors/common.error';
import Platform from '@share/errors/platform.error';
...
export default class AppError extends SystemError<typeof AppErrorCode> {}
